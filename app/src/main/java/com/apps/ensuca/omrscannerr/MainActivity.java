    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == MY_STORAGE_PERMISSION_CODE) {
            if (null != grantResults && grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, "Depolama izni reddedilsi", Toast.LENGTH_LONG).show();
            }
        }
    }
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                try {
                    ...
                    Toast.makeText(this, "Formu okurken bir hata oluştu. Lütfen tekrar deneyiniz", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
